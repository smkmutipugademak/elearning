...
const quizData = [
    ...
    },
    {
        ...
        q: "Apa langkah pertama sebelum membuat prototype?",
        a: [
        ...
        correct: 1,
        pembahasan: "Prototype harus dibuat berdasarkan kebutuhan dan masalah pengguna yang ditemukan melalui riset."
    },
    {
        q: "Mid-fidelity prototype biasanya memiliki...",
        a: [
            "Sketsa tanpa grid",
            "Visual lebih rapi dengan struktur jelas, namun belum berwarna penuh",
            "Interaksi kompleks dan realistis",
            "Kode backend"
        ],
        correct: 1,
        pembahasan: "Mid-fidelity berada di tengah-tengah: struktur detail tetapi visual belum final."
    },
    {
        q: "Dalam prototyping, istilah 'iteration' berarti...",
        a: [
            "Membuat halaman baru",
            "Mengulang proses untuk memperbaiki prototype berdasarkan feedback",
            "Menghapus seluruh desain",
            "Mengganti software desain"
        ],
        correct: 1,
        pembahasan: "Iteration adalah proses mengulang dan memperbaiki desain hingga sesuai kebutuhan."
    },
    {
        q: "Mengapa prototype harus diuji pada pengguna nyata?",
        a: [
            "Agar developer tidak bekerja terlalu keras",
            "Untuk mengetahui apakah desain sesuai kebutuhan pengguna",
            "Agar desain terlihat bagus",
            "Untuk keperluan dokumentasi"
        ],
        correct: 1,
        pembahasan: "Testing pengguna membantu menemukan masalah yang mungkin tidak terlihat oleh desainer."
    },
    {
        q: "Salah satu tanda prototype buruk adalah...",
        a: [
            "Terlalu banyak interaksi",
            "Membingungkan dan tidak menunjukkan alur penggunaan dengan jelas",
            "Terlalu sederhana",
            "Menggunakan warna hitam putih"
        ],
        correct: 1,
        pembahasan: "Prototype harus jelas menjelaskan alur penggunaan. Bila membingungkan, berarti kualitasnya buruk."
    },
    {
        q: "Prototype biasanya dibangun berdasarkan...",
        a: [
            "Hipotesis dan hasil riset pengguna",
            "Desain acak dari internet",
            "Pilihan warna favorit desainer",
            "Tampilan aplikasi kompetitor saja"
        ],
        correct: 0,
        pembahasan: "Prototype dibuat berdasarkan hipotesis yang berasal dari data riset."
    },
    {
        q: "Transition atau animasi kecil pada prototype bertujuan untuk...",
        a: [
            "Mempercantik presentasi",
            "Mensimulasikan pengalaman nyata pengguna",
            "Membuat coding lebih cepat",
            "Mengurangi ukuran file"
        ],
        correct: 1,
        pembahasan: "Animasi kecil membantu meniru alur aplikasi sebenarnya dan meningkatkan pemahaman pengguna."
    },
    {
        q: "Apa peran prototyping dalam Design Thinking?",
        a: [
            "Langkah untuk memvalidasi solusi melalui eksperimen",
            "Proses yang dilakukan sebelum riset pengguna",
            "Cara untuk mempercepat coding backend",
            "Proses yang dilakukan setelah aplikasi selesai"
        ],
        correct: 0,
        pembahasan: "Prototyping adalah tahap eksperimen untuk menguji solusi sebelum pembangunan final."
    },
    {
        q: "Apa indikator bahwa prototype siap diuji?",
        a: [
            "Semua halaman sudah berwarna penuh",
            "Fungsi utama dan alur interaksi sudah jelas",
            "Tampilan sudah seperti aplikasi final",
            "Keseluruhan backend sudah selesai"
        ],
        correct: 1,
        pembahasan: "Yang terpenting untuk testing adalah alur dan fungsi utama, bukan visual akhir."
    },
    {
        q: "Ketika hasil pengujian menunjukkan banyak masalah pada prototype, langkah yang benar adalah...",
        a: [
            "Tetap melanjutkan pembangunan aplikasi",
            "Mengabaikan feedback karena prototype hanya contoh",
            "Melakukan revisi dan iterasi berdasarkan feedback",
            "Mengganti semua warna desain"
        ],
        correct: 2,
        pembahasan: "Feedback adalah dasar untuk iterasi dan perbaikan prototype."
    }
];
