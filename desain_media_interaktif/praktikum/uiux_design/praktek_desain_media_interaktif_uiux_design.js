...
const quizData = [
    ...
    },
    {
        ...
        q: "Layout grid dalam UI digunakan untuk...",
        a: [
            "Membuat animasi",
            "Menjaga keteraturan dan keseimbangan tata letak",
            "Mengatur database",
            "Mempercepat loading aplikasi"
        ],
        correct: 1,
        pembahasan: "Grid membantu memastikan tata letak konsisten dan rapi."
    },
    {
        q: "Apa tujuan utama dari user flow?",
        a: [
            "Menentukan warna desain",
            "Menunjukkan langkah-langkah yang diambil pengguna untuk mencapai tujuan",
            "Membuat struktur database",
            "Mengatur ukuran elemen UI"
        ],
        correct: 1,
        pembahasan: "User Flow menggambarkan jalur yang dilalui pengguna dalam aplikasi."
    },
    {
        q: "Micro-interaction digunakan untuk...",
        a: [
            "Pergerakan halaman besar",
            "Animasi kecil yang memberi umpan balik kepada pengguna",
            "Membuat backend aplikasi",
            "Meningkatkan kapasitas server"
        ],
        correct: 1,
        pembahasan: "Micro-interaction mencakup animasi kecil seperti tombol yang berubah saat ditekan."
    },
    {
        q: "Apa itu responsive design?",
        a: [
            "Desain yang hanya bekerja di desktop",
            "Desain yang berbeda untuk setiap aplikasi",
            "Desain yang menyesuaikan tampilan berdasarkan ukuran layar",
            "Desain khusus game"
        ],
        correct: 2,
        pembahasan: "Responsive design memastikan tampilan tetap optimal di berbagai perangkat."
    },
    {
        q: "Apa itu accessibility dalam UI/UX?",
        a: [
            "Desain untuk meningkatkan kecepatan server",
            "Desain yang bisa digunakan oleh semua orang, termasuk penyandang disabilitas",
            "Desain khusus developer",
            "Desain untuk mempercepat proses coding"
        ],
        correct: 1,
        pembahasan: "Accessibility fokus pada inklusivitas agar semua pengguna dapat menggunakan aplikasi."
    },
    {
        q: "Kontras warna penting dalam UI karena...",
        a: [
            "Untuk mempercepat animasi",
            "Untuk memudahkan pengguna melihat dan membaca elemen",
            "Untuk membuat warna lebih cerah",
            "Untuk mengurangi ukuran file"
        ],
        correct: 1,
        pembahasan: "Kontras warna membantu keterbacaan dan kenyamanan visual."
    },
    {
        q: "Apa itu A/B Testing?",
        a: [
            "Pengujian server",
            "Mengubah warna random",
            "Menguji dua versi desain untuk mengetahui mana yang lebih efektif",
            "Menguji kecepatan hardware"
        ],
        correct: 2,
        pembahasan: "A/B Testing membandingkan dua versi desain untuk mencari performa terbaik."
    },
    {
        q: "Affinity Diagram digunakan untuk...",
        a: [
            "Mengelompokkan ide atau temuan riset berdasarkan kesamaan",
            "Membuat animasi 2D",
            "Menentukan skema warna",
            "Mengatur struktur file desain"
        ],
        correct: 0,
        pembahasan: "Affinity Diagram menyatukan ide-ide yang mirip agar mudah dianalisis."
    },
    {
        q: "Moodboard berfungsi untuk...",
        a: [
            "Mencatat data pengguna",
            "Menghasilkan prototipe interaktif",
            "Mengumpulkan referensi visual untuk menentukan arah desain",
            "Mengedit video"
        ],
        correct: 2,
        pembahasan: "Moodboard berisi kumpulan gaya visual, warna, dan inspirasi untuk desain."
    },
    {
        q: "Gestalt principles digunakan untuk...",
        a: [
            "Membuat animasi",
            "Mengatur struktur backend",
            "Memahami cara manusia melihat dan mengelompokkan objek",
            "Mengatur server"
        ],
        correct: 2,
        pembahasan: "Prinsip Gestalt menjelaskan pola persepsi visual manusia terhadap objek."
    },
    {
        q: "Typography berfokus pada...",
        a: [
            "Pemilihan dan pengaturan huruf agar nyaman dibaca",
            "Membuat efek 3D",
            "Mendesain backend",
            "Pengaturan struktur database"
        ],
        correct: 0,
        pembahasan: "Tipografi memastikan teks terlihat rapi, mudah dibaca, dan estetis."
    },
    {
        q: "Low-fidelity prototype memiliki ciri...",
        a: [
            "Sangat mirip produk akhir",
            "Tidak memiliki interaksi dan hanya berupa sketsa sederhana",
            "Termasuk animasi penuh",
            "Memiliki coding backend"
        ],
        correct: 1,
        pembahasan: "Low-fidelity prototype biasanya berupa wireframe sederhana tanpa interaksi."
    },
    {
        q: "Apa fungsi utama dari style guide?",
        a: [
            "Dokumen panduan agar desain tetap konsisten",
            "Pengaturan struktur backend",
            "Mengedit elemen 3D",
            "Mengatur konfigurasi server"
        ],
        correct: 0,
        pembahasan: "Style guide berisi aturan warna, tipografi, dan komponen untuk menjaga konsistensi."
    },
    {
        q: "Jakob’s Law menyatakan bahwa...",
        a: [
            "Pengguna menyukai desain yang unik",
            "Pengguna ingin aplikasi berbeda dari aplikasi lain",
            "Pengguna lebih nyaman jika aplikasi bekerja mirip dengan aplikasi yang sudah mereka kenal",
            "Pengguna perlu belajar ulang tiap aplikasi"
        ],
        correct: 2,
        pembahasan: "Jakob’s Law menjelaskan pentingnya mengikuti pola desain umum agar mudah dipahami."
    }, {
        q: "Pain point dalam UX berarti...",
        a: [
            "Warna desain",
            "Masalah atau hambatan yang dialami pengguna",
            "Kecepatan loading aplikasi",
            "Jumlah fitur aplikasi"
        ],
        correct: 1,
        pembahasan: "Pain point adalah masalah yang dialami pengguna dalam interaksi dengan produk."
    }
];
