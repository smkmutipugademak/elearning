...
const quizData = [
    {
        ...
        a: ["Memotong audio", "Memilih area audio untuk diedit", "Menghapus noise", "Menambah efek reverb", "Mengatur balance speaker"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Envelope Tool", "Time Shift Tool", "Draw Tool", "Zoom Tool", "Multi-Tool"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Normalize", "Noise Reduction", "Equalization", "Limiter", "Reverb"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Draw Tool", "Zoom Tool", "Envelope Tool", "Sync-Lock Tracks", "Time Shift Tool"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Compressor", "Amplify", "Fade In", "Echo", "Distortion"],
        correct: 0,
        pembahasan: "Compressor menyeimbangkan dinamika suara."
    },
    {
        q: "Fitur Normalize digunakan untuk...",
        a: ["Menghapus noise", "Mengatur level puncak audio ke nilai tertentu", "Mempercepat audio", "Membalikkan audio", "Menggabungkan track"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Delete", "Trim Audio", "Split Audio", "Cut", "Paste"],
        correct: 1,
        pembahasan: "Trim Audio membuang bagian di luar seleksi."
    },
    {
        q: "Fungsi dari Envelope Tool adalah...",
        a: ["Menggambar ulang bentuk waveform", "Mengatur volume secara bertahap", "Memotong track", "Menghapus clip", "Menambah efek gema"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Draw Tool", "Pen Tool", "Shape Tool", "Node Tool", "Brush Tool"],
        correct: 0,
    ...
    },
    {
        ...
        a: ["Track > Split Stereo to Mono", "Effect > Split", "Audio > Convert", "Tools > Unmerge", "File > Export Multiple"],
        correct: 0,
        pembahasan: "Audacity menyediakan opsi langsung untuk split stereo."
    },
    {
        q: "Efek apakah yang digunakan untuk membuat suara bergema?",
        a: ["Echo", "Limiter", "Compressor", "Noise Gate", "Invert"],
        correct: 0,
    ...
    },
    {
        ...
        a: ["Noise Reduction", "Amplify negatif", "Envelope Tool", "High-pass Filter", "Low-pass Filter"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Limiter", "Reverb", "Bass Boost", "Normalize", "Wah-Wah"],
        correct: 0,
    ...
    },
    {
        ...
        a: ["Amplify", "Pan Adjustment", "Split Stereo to Mono", "Normalize Left Channel", "Invert"],
        correct: 1,
        pembahasan: "Pan mengatur posisi suara L-R."
    },
    {
        q: "Untuk mengekspor audio ke format MP3, Audacity memerlukan...",
        a: ["Codec tambahan LAME", "Plugin WAV", "No additional plugin", "ASIO Driver", "DirectX Driver"],
        correct: 0,
        pembahasan: "Audacity membutuhkan LAME MP3 encoder pada versi lama."
    },
    {
        q: "Efek 'Change Pitch' mengubah...",
        a: ["Kecepatan audio", "Nada audio", "Volume", "Frekensiu low-end saja", "Durasi audio"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Ctrl + A", "Ctrl + Shift + A", "A", "Alt + A", "Ctrl + S"],
        correct: 0,
        pembahasan: "Ctrl + A adalah shortcut umum untuk Select All."
    },
    {
        q: "Efek NOTCH Filter digunakan untuk...",
        a: ["Menghilangkan frekuensi tertentu", "Menambah bass", "Menghapus noise", "Menambah echo", "Memotong durasi"],
        correct: 0,
        pembahasan: "Notch Filter menghapus frekuensi sempit yang mengganggu."
    },
    {
        q: "Time Stretch digunakan untuk...",
        a: ["Mengubah volume", "Mengubah durasi klip", "Menghapus bass", "Menggabungkan track", "Mengubah format file"],
        correct: 1,
        pembahasan: "Time Stretch mengubah panjang audio."
    },
    {
        q: "Fitur Noise Gate berfungsi untuk...",
        a: ["Menambah noise", "Mengurangi suara yang berada di bawah threshold tertentu", "Meningkatkan gain", "Menambah echo", "Menghilangkan frekuensi tinggi"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Copy", "Store", "Export", "Repeat", "Duplicate"],
        correct: 0,
        pembahasan: "Copy menyalin area terpilih."
    },
    {
        q: "Equalization (EQ) digunakan untuk...",
        a: ["Mengubah pitch", "Mengatur frekuensi audio", "Menghapus clip", "Menggabungkan track", "Mengubah tempo"],
        correct: 1,
        pembahasan: "EQ mengatur frekuensi tinggi, rendah, maupun mid."
    },
    {
        q: "Fungsi utama 'Spectrogram View' adalah...",
        a: ["Melihat waveform", "Melihat intensitas frekuensi audio", "Menghapus noise", "Melakukan mixing", "Mengedit metadata"],
        correct: 1,
        pembahasan: "Spectrogram menampilkan frekuensi dalam bentuk warna dan intensitas."
    },
    {
        q: "Menu 'Align Tracks' digunakan untuk...",
        a: ["Mensinkronkan awal track", "Menghapus track", "Mengubah waveform", "Mengatur pan", "Mengubah warna track"],
        correct: 0,
        pembahasan: "Align menyelaraskan posisi beberapa track."
    },
    {
        q: "Efek Reverb digunakan untuk...",
        a: ["Menghapus noise", "Menambah ruang atau ambience", "Menstabilkan volume", "Menghapus breath", "Menambah distorsi"],
        correct: 1,
    ...
    },
    {
        ...
        a: ["Join", "Mix and Render", "Combine", "Merge", "Export Selected"],
        correct: 1,
