...
const quizData = [
    ...
    },
    {
        q: "Apa yang dimaksud dengan animasi interaktif?",
        a: [
            "Animasi yang hanya berjalan otomatis",
            "Animasi yang melibatkan interaksi pengguna",
            "Animasi yang dibuat menggunakan gambar statis",
            "Animasi dalam bentuk video linear",
            "Animasi tanpa kontrol pengguna"
        ],
        correct: 1,
        pembahasan: "Animasi interaktif adalah animasi yang berubah atau bereaksi berdasarkan input dari pengguna."
    },
    {
        q: "Software mana yang paling umum digunakan untuk membuat animasi interaktif berbasis web?",
        a: [
            "Adobe Premiere Pro",
            "Adobe Animate",
            "Sony Vegas",
        ...
        correct: 1,
        pembahasan: "Adobe Animate dirancang khusus untuk membuat animasi dan konten interaktif berbasis HTML5."
    },
    {
        q: "Konsep 'event listener' digunakan untuk...",
        a: [
            "Menambahkan efek visual",
            "Mendeteksi interaksi pengguna",
            "Mengatur kecepatan animasi",
            "Membuat timeline animasi",
            "Mengatur ukuran objek"
        ],
        correct: 1,
        pembahasan: "Event listener berfungsi menangkap aksi pengguna seperti klik, hover, atau gerakan mouse."
    },
    {
        q: "Contoh animasi interaktif adalah...",
        a: [
            "Film animasi 3D",
            "Video musik",
            "Game edukasi berbasis web",
            "Animasi GIF",
            "Video cinematic"
        ],
        correct: 2,
        pembahasan: "Game edukasi berbasis web melibatkan interaksi pengguna sehingga termasuk animasi interaktif."
    },
    {
        q: "Dalam animasi interaktif, istilah 'trigger' berarti...",
        a: [
            "Efek khusus pada objek",
            "Aksi pengguna yang memicu animasi",
            "Warna pada objek animasi",
            "Proses rendering animasi",
            "Proses pemberian suara"
        ],
        correct: 1,
        pembahasan: "Trigger adalah pemicu, biasanya berasal dari tindakan pengguna."
    },
    {
        q: "HTML5 Canvas digunakan untuk...",
        a: [
            "Membuat tabel data",
            "Mengedit foto",
            "Menggambar dan menganimasikan objek secara interaktif",
            "Mengedit audio",
            "Mengatur layout website"
        ],
        correct: 2,
        pembahasan: "Canvas memungkinkan penggambaran grafik, animasi, dan interaksi secara real-time."
    },
    {
        q: "Pada pembuatan animasi interaktif, FPS digunakan untuk menentukan...",
        a: [
            "Ukuran file animasi",
        ...
        correct: 1,
        pembahasan: "FPS menentukan seberapa halus animasi ditampilkan."
    },
    {
        q: "Interaktivitas dalam animasi terutama ditambahkan melalui...",
        a: [
            "Kode pemrograman",
            "Layer tambahan",
            "Efek blur",
        ...
        correct: 0,
        pembahasan: "Kode seperti JavaScript digunakan untuk menambahkan interaksi dalam animasi."
    },
    {
        q: "User Interface (UI) dalam animasi interaktif berfungsi untuk...",
        a: [
            "Mengatur warna background",
            "Memberikan kontrol kepada pengguna",
            "Meringankan ukuran file",
            "Mempercepat rendering",
            "Mengatur kompresi"
        ],
        correct: 1,
        pembahasan: "UI adalah bagian yang digunakan pengguna untuk mengontrol animasi."
    },
    {
        q: "Animasi interaktif umumnya digunakan dalam bidang berikut, kecuali...",
        a: [
            "Game",
            "E-learning",
            "Simulasi",
        ...
        correct: 3,
        pembahasan: "Film bioskop linear tidak interaktif karena penonton tidak memberikan input apa pun."
    }
];
